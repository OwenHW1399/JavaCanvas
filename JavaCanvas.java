...
public class JavaCanvas extends JFrame
{
		...
		*/
        ...
        public JavaCanvas()
        {
            ...
            brushBut = makeMeButtons("./src/brush (2).png", 1);
            lineBut = makeMeButtons("./src/straight.png", 2);
            ellipseBut = makeMeButtons("./src/oval.png", 3);
            ...
            transSlider = new JSlider(1, 99, 1);
        ...
        public JButton makeMeButtons(String iconFile, final int actionNum){
            ...
            theBut.setIcon(new ImageIcon(iconFile));
        	/*JButton theBut = new JButton();
